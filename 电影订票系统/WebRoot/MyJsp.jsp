    ...
    #bgbox {
        ...
        left: 140px;
        top: 40px;
        background-image: url(images/home/onshow-bg.png);
    }
    ...
    <div id="bgbox">
      <div id="apDiv1">
        <marquee loop="-1" scrollamount="4" width="800" marqueedirection="right" onMouseOver="this.stop();" onMouseOut="this.start();" id="marquee"bb" >
        <%  DB db=new DB();//连接数据库
        PreparedStatement pstmt;
        try {
            pstmt = db.getConn().prepareStatement("select * from movieInfo where 状态=?");
            pstmt.setString(1,"正在上映");
    ...
    <div id="btn_user">
              <table width="120" height="51" border="0">
                <tr>
                  <td width="26" height="26"><img src="images/home/login-icon.png" alt=""></td>
                  <td width="47" height="26"><a href="login.jsp"><img src="images/home/login-bt.png" alt=""></a></td>
                  <td width="47" height="26"><a href="register.jsp"><img src="images/home/register-bt.png" alt=""></a></td>
                </tr>
      </table>
    </div>
