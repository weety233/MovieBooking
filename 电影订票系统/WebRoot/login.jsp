...
<div id="box">
   ...
   <div id="apDiv4"><a href="userLogin.jsp" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image8','','images/login/user-bt-off-light_03.png',1)"><img src="images/login/user-bt-off-gray_03.png" name="Image8" width="122" height="34" border="0" id="Image8" /></a>
   
   
     <div id="apDiv5"><a href="adminLogin.jsp" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image9','','images/login/manage-bt-off-light_03.png',0)"><img src="images/login/manage-bt-off-gray_03.png" name="Image9" width="122" height="34" border="0" id="Image9" /></a></div>
   </div>
  <form action="" method="post">
    <div id="apDiv2"><input type="text" name="KK" id="KK" disabled="disabled" /></div>
   <div id="apDiv3"><input type="password" name="KK" id="KK" disabled="disabled" /></div>
   <div id="queren"><input type="image" src="images/login/enter-on.png" disabled="disabled"/></div>
 </form>
</div>
