...
#bgbox {
	...
	left: 140px;
	top: 40px;
	background-image: url(images/modifymessage/modifiymessage-bg.png);
}
...
#apDiv1 {
	...
	height:342px;
	z-index:4;
	background-image: url(images/modifymessage/modifymessage-box_03.png);
	left: 533px;
	top: 122px;
}
#apDiv2 {
...
<script>alert('不好意思，您还没有登录，不可以修改个人信息！');</script>
<%
...
<div id="apDiv1">
                  ...
                  <div id="apDiv2">
                    <input type="text" name="telephone" id="KK" />
                  </div>
                  <div id="apDiv3">                 
                    <input type="text" name="realName" id="KK" />    
                  </div>
            <div id="apDiv4">
                      <input type="text" name="cardNum" id="KK" />
                   </div>    
                    <div id="apDiv5">
